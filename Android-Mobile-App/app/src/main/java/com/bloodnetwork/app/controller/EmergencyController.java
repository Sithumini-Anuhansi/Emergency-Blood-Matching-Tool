...
public class EmergencyController 
{
    ...
    private com.bloodnetwork.app.service.LocationService locationService;
    private Graph graph;
    ...
    public EmergencyController(HospitalService hospitalService,
                               ...
                               com.bloodnetwork.app.service.LocationService locationService) 
{
    ...
    public List<MatchResult> findMatches(String bloodGroup, int quantity, String hospitalLocationId) 
    {
        ...
        // Sort by distance, then type (Blood Bank first)
    ...
    private void notifyMatch(EmergencyRequest er, MatchResult match, String hospitalName, String prefix) 
    {
        ...
        notificationService.send(match.getId(), title, body, er.getId());
    ...
    public boolean donorAccept(String requestId, EmergencyRequest er) 
    {
        ...
        if (ok) 
        {
            ...
            notificationService.expireNotificationsForRequest(er.getId(), "This request has already been fulfilled by another donor.");
            ...
            if (dr != null) 
            {
                ...
                Hospital hospital = hospitalService.findHospital(er.getHospitalId());
                String hospitalName = (hospital != null) ? hospital.getName() : "the hospital";
                ...
                notificationService.send(dr.getDonorId(), "Success",
                        "You have accepted the request for " + hospitalName + ". They may contact you at " + contact);
            }
        }
        return ok;
    }
    ...
    public boolean bankAccept(String erId, String bankId) 
    {
        ...
        Hospital hospital = hospitalService.findHospital(er != null ? er.getHospitalId() : null);
        ...
        {
            reduceStock(bankId, er.getBloodGroup(), er.getQuantity(), hospitalName);
            ...
            notificationService.expireNotificationsForRequest(erId, "This request has been fulfilled by a blood bank.");
            ...
            notificationService.send(bankId, "Request Fulfilled", 
                    "You have issued blood for " + hospitalName + " (" + erId + "). Hospital notified.");
            return true;
        }
        return false;
    }
    ...
    public void addStock(String bankId, String bloodGroup, int quantity) 
    {
        ...
        transactionService.record(bankId, bloodGroup, quantity, "ADD", "Stock Addition");
    ...
    public void reduceStock(String bankId, String bloodGroup, int quantity, String hospitalName) 
    {
        bloodBankService.reduceStock(bankId, bloodGroup, quantity);
        transactionService.record(bankId, bloodGroup, quantity, "ISSUE", hospitalName);
        // Low stock warning
    ...
    public com.bloodnetwork.app.model.Location addNewLocation(String name) 
    {
        return locationService.addNewLocation(name);
    }
