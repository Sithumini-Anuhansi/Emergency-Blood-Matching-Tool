...
public class EmergencyController 
{
    ...
    public EmergencyRequest createRequest
        ( String requestId, String hospitalId, String bloodGroup, int quantity )
    {
        ...
        EmergencyRequest request = new EmergencyRequest
                ( requestId, hospital, bloodGroup, quantity );

        return request;
    }

    // Check blood bank availability
    public void checkBloodBanks( EmergencyRequest request )
    {
        ...
        if(banks.isEmpty())
        {
            System.out.println( "No blood available in blood banks");
        }
        else
        {
            System.out.println( "Available Blood Banks:");
    ...
    // Search donors
    public void findDonors( EmergencyRequest request )
    {
    ...
    {
        responseService.acceptDonorRequest( donorId, request );
    }

    // Donor rejects request
    public void rejectDonor( String donorId, EmergencyRequest request )
    {
        responseService.rejectDonorRequest( donorId, request);
    }
}