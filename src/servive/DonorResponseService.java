...
public class DonorResponseService {
     ...
     */
    public boolean acceptDonorRequest(
            String donorId,
     ...
     */
    public boolean rejectDonorRequest(
            String donorId,
            EmergencyRequest request
    ){
        ...
        if(rejected){
            ...
            if(queueService
                ...
                request.setStatus(
                        RequestStatus.WAITING_FOR_DONOR
                );
