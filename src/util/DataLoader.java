...
public class DataLoader {
    ...
    /*
     * Load locations and add them to Graph
     *
     ...
     * roads.csv format:
     *
     * Source,Destination,Distance,TravelTime
     *
     */
     ...
     *
     * HospitalID,HospitalName,LocationID
     *
     */
     ...
     * Load blood banks
     *
     * bloodbanks.csv format:
     *
     * BankID,Name,LocationID,
     * O+,A+,B+,AB+,O-,A-,B-,AB-
     *
     */
    public static void loadBloodBanks(
            String filePath,
     ...
     * Phone,Available,Eligible,LocationID
     *
     */
